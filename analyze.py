...
for file_path in file_path_list:
    ...
    if sensor_id in allowed_fan_sensor_ids and (combined_timestamp >= '20231018_000000' and combined_timestamp <= '20231121_000000'):
        fan_csv_path_to_checked.add(file_path)
    elif sensor_id in allowed_motor_sensor_ids and (combined_timestamp >= '20231018_000000' and combined_timestamp <= '20231121_000000'):
...
customized_period_to = '2023-11-21'
...
WITH cte AS (
 ...
 FROM cte
 WHERE rn = 1 and computation_type = 'manual' and extracted_datetime >= '2023-10-18' and extracted_datetime <= '2023-11-21'
...
FROM cte
WHERE rn = 1 and extracted_datetime >= '2023-09-18 00:00:00' and extracted_datetime <= '2023-11-18 00:00:00'
ORDER BY extracted_datetime ASC;
"""
cursor_xswh.execute(latest_records_query_model)
model_computation_records = cursor_xswh.fetchall()

model_fan_balancing_6B_Rm1_No1_list = []
model_fan_balancing_6B_Rm1_No2_list = []
model_fan_balancing_6B_Rm2_No1_list = []
model_fan_balancing_6B_Rm2_No2_list = []
model_fan_misalignment_6B_Rm1_No1_list = []
model_fan_misalignment_6B_Rm1_No2_list = []
model_fan_misalignment_6B_Rm2_No1_list = []
model_fan_misalignment_6B_Rm2_No2_list = []
model_fan_bearing_6B_Rm1_No1_list = []
model_fan_bearing_6B_Rm1_No2_list = []
model_fan_bearing_6B_Rm2_No1_list = []
model_fan_bearing_6B_Rm2_No2_list = []
model_fan_flow_6B_Rm1_No1_list = []
model_fan_flow_6B_Rm1_No2_list = []
model_fan_flow_6B_Rm2_No1_list = []
model_fan_flow_6B_Rm2_No2_list = []
model_fan_belt_6B_Rm1_No1_list = []
model_fan_belt_6B_Rm1_No2_list = []
model_fan_belt_6B_Rm2_No1_list = []
model_fan_belt_6B_Rm2_No2_list = []

model_motor_balancing_6B_Rm1_No1_list = []
model_motor_balancing_6B_Rm1_No2_list = []
model_motor_balancing_6B_Rm2_No1_list = []
model_motor_balancing_6B_Rm2_No2_list = []
model_motor_misalignment_6B_Rm1_No1_list = []
model_motor_misalignment_6B_Rm1_No2_list = []
model_motor_misalignment_6B_Rm2_No1_list = []
model_motor_misalignment_6B_Rm2_No2_list = []
model_motor_bearing_6B_Rm1_No1_list = []
model_motor_bearing_6B_Rm1_No2_list = []
model_motor_bearing_6B_Rm2_No1_list = []
model_motor_bearing_6B_Rm2_No2_list = []
model_motor_belt_6B_Rm1_No1_list = []
model_motor_belt_6B_Rm1_No2_list = []
model_motor_belt_6B_Rm2_No1_list = []
model_motor_belt_6B_Rm2_No2_list = []
    ...
    if location_name == 'Fan-DE':
        if health_type == 'balancing':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_fan_balancing_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_fan_balancing_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_fan_balancing_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_fan_balancing_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'misalignment':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_fan_misalignment_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_fan_misalignment_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_fan_misalignment_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_fan_misalignment_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'bearing':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_fan_bearing_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_fan_bearing_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_fan_bearing_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_fan_bearing_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'belt':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_fan_belt_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_fan_belt_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_fan_belt_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_fan_belt_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'flow':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_fan_flow_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_fan_flow_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_fan_flow_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_fan_flow_6B_Rm2_No2_list.append([mae, extracted_datetime])
        
    elif location_name == 'Motor':
        if health_type == 'balancing':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_motor_balancing_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_motor_balancing_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_motor_balancing_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_motor_balancing_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'misalignment':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_motor_misalignment_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_motor_misalignment_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_motor_misalignment_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_motor_misalignment_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'bearing':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_motor_bearing_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_motor_bearing_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_motor_bearing_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_motor_bearing_6B_Rm2_No2_list.append([mae, extracted_datetime])

        elif health_type == 'belt':
            if machine_name == '6B ISO Rm 1 Fan no.1':
                model_motor_belt_6B_Rm1_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 1 Fan no.2':
                model_motor_belt_6B_Rm1_No2_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.1':
                model_motor_belt_6B_Rm2_No1_list.append([mae, extracted_datetime])
            elif machine_name == '6B ISO Rm 2 Fan no.2':
                model_motor_belt_6B_Rm2_No2_list.append([mae, extracted_datetime])


# Fan
model_fan_balancing_6B_Rm1_No1_df = pd.DataFrame(model_fan_balancing_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_fan_balancing_6B_Rm1_No2_df = pd.DataFrame(model_fan_balancing_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_fan_balancing_6B_Rm2_No1_df = pd.DataFrame(model_fan_balancing_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_fan_balancing_6B_Rm2_No2_df = pd.DataFrame(model_fan_balancing_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_fan_misalignment_6B_Rm1_No1_df = pd.DataFrame(model_fan_misalignment_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_fan_misalignment_6B_Rm1_No2_df = pd.DataFrame(model_fan_misalignment_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_fan_misalignment_6B_Rm2_No1_df = pd.DataFrame(model_fan_misalignment_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_fan_misalignment_6B_Rm2_No2_df = pd.DataFrame(model_fan_misalignment_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_fan_bearing_6B_Rm1_No1_df = pd.DataFrame(model_fan_bearing_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_fan_bearing_6B_Rm1_No2_df = pd.DataFrame(model_fan_bearing_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_fan_bearing_6B_Rm2_No1_df = pd.DataFrame(model_fan_bearing_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_fan_bearing_6B_Rm2_No2_df = pd.DataFrame(model_fan_bearing_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_fan_flow_6B_Rm1_No1_df = pd.DataFrame(model_fan_flow_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_fan_flow_6B_Rm1_No2_df = pd.DataFrame(model_fan_flow_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_fan_flow_6B_Rm2_No1_df = pd.DataFrame(model_fan_flow_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_fan_flow_6B_Rm2_No2_df = pd.DataFrame(model_fan_flow_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_fan_belt_6B_Rm1_No1_df = pd.DataFrame(model_fan_belt_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_fan_belt_6B_Rm1_No2_df = pd.DataFrame(model_fan_belt_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_fan_belt_6B_Rm2_No1_df = pd.DataFrame(model_fan_belt_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_fan_belt_6B_Rm2_No2_df = pd.DataFrame(model_fan_belt_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

# Motor
model_motor_balancing_6B_Rm1_No1_df = pd.DataFrame(model_motor_balancing_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_motor_balancing_6B_Rm1_No2_df = pd.DataFrame(model_motor_balancing_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_motor_balancing_6B_Rm2_No1_df = pd.DataFrame(model_motor_balancing_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_motor_balancing_6B_Rm2_No2_df = pd.DataFrame(model_motor_balancing_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_motor_misalignment_6B_Rm1_No1_df = pd.DataFrame(model_motor_misalignment_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_motor_misalignment_6B_Rm1_No2_df = pd.DataFrame(model_motor_misalignment_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_motor_misalignment_6B_Rm2_No1_df = pd.DataFrame(model_motor_misalignment_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_motor_misalignment_6B_Rm2_No2_df = pd.DataFrame(model_motor_misalignment_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_motor_bearing_6B_Rm1_No1_df = pd.DataFrame(model_motor_bearing_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_motor_bearing_6B_Rm1_No2_df = pd.DataFrame(model_motor_bearing_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_motor_bearing_6B_Rm2_No1_df = pd.DataFrame(model_motor_bearing_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_motor_bearing_6B_Rm2_No2_df = pd.DataFrame(model_motor_bearing_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

model_motor_belt_6B_Rm1_No1_df = pd.DataFrame(model_motor_belt_6B_Rm1_No1_list, columns=['6B_Rm1_No1_mae', '6B_Rm1_No1_extracted_datetime'])
model_motor_belt_6B_Rm1_No2_df = pd.DataFrame(model_motor_belt_6B_Rm1_No2_list, columns=['6B_Rm1_No2_mae', '6B_Rm1_No2_extracted_datetime'])
model_motor_belt_6B_Rm2_No1_df = pd.DataFrame(model_motor_belt_6B_Rm2_No1_list, columns=['6B_Rm2_No1_mae', '6B_Rm2_No1_extracted_datetime'])
model_motor_belt_6B_Rm2_No2_df = pd.DataFrame(model_motor_belt_6B_Rm2_No2_list, columns=['6B_Rm2_No2_mae', '6B_Rm2_No2_extracted_datetime'])

import matplotlib.pyplot as plt

# Fan
fig_model_fan_balancing, ax_model_fan_balancing = plt.subplots()
plt.plot(model_fan_balancing_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_fan_balancing_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_fan_balancing_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_fan_balancing_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_fan_balancing_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_fan_balancing_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_fan_balancing_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_fan_balancing_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Fan Balancing')
plt.legend()

fig_model_fan_misalignment, ax_model_fan_misalignment = plt.subplots()
plt.plot(model_fan_misalignment_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_fan_misalignment_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_fan_misalignment_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_fan_misalignment_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_fan_misalignment_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_fan_misalignment_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_fan_misalignment_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_fan_misalignment_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Fan Misalignment')
plt.legend()

fig_model_fan_bearing, ax_model_fan_bearing = plt.subplots()
plt.plot(model_fan_bearing_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_fan_bearing_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_fan_bearing_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_fan_bearing_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_fan_bearing_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_fan_bearing_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_fan_bearing_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_fan_bearing_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Fan Bearing')
plt.legend()

fig_model_fan_flow, ax_model_fan_flow = plt.subplots()
plt.plot(model_fan_flow_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_fan_flow_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_fan_flow_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_fan_flow_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_fan_flow_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_fan_flow_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_fan_flow_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_fan_flow_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Fan Flow')
plt.legend()

fig_model_fan_belt, ax_model_fan_belt = plt.subplots()
plt.plot(model_fan_belt_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_fan_belt_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_fan_belt_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_fan_belt_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_fan_belt_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_fan_belt_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_fan_belt_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_fan_belt_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Fan Belt')
plt.legend()

# Motor
fig_model_motor_balancing, ax_model_motor_balancing = plt.subplots()
plt.plot(model_motor_balancing_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_motor_balancing_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_motor_balancing_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_motor_balancing_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_motor_balancing_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_motor_balancing_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_motor_balancing_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_motor_balancing_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Motor Balancing')
plt.legend()

fig_model_motor_misalignment, ax_model_motor_misalignment = plt.subplots()
plt.plot(model_motor_misalignment_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_motor_misalignment_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_motor_misalignment_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_motor_misalignment_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_motor_misalignment_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_motor_misalignment_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_motor_misalignment_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_motor_misalignment_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Motor Misalignment')
plt.legend()

fig_model_motor_bearing, ax_model_motor_bearing = plt.subplots()
plt.plot(model_motor_bearing_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_motor_bearing_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_motor_bearing_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_motor_bearing_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_motor_bearing_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_motor_bearing_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_motor_bearing_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_motor_bearing_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Motor Bearing')
plt.legend()

fig_model_motor_belt, ax_model_motor_belt = plt.subplots()
plt.plot(model_motor_belt_6B_Rm1_No1_df['6B_Rm1_No1_extracted_datetime'], model_motor_belt_6B_Rm1_No1_df['6B_Rm1_No1_mae'], label='6B_Rm1_No1')
plt.plot(model_motor_belt_6B_Rm1_No2_df['6B_Rm1_No2_extracted_datetime'], model_motor_belt_6B_Rm1_No2_df['6B_Rm1_No2_mae'], label='6B_Rm1_No2')
plt.plot(model_motor_belt_6B_Rm2_No1_df['6B_Rm2_No1_extracted_datetime'], model_motor_belt_6B_Rm2_No1_df['6B_Rm2_No1_mae'], label='6B_Rm2_No1')
plt.plot(model_motor_belt_6B_Rm2_No2_df['6B_Rm2_No2_extracted_datetime'], model_motor_belt_6B_Rm2_No2_df['6B_Rm2_No2_mae'], label='6B_Rm2_No2')
plt.xlabel('Datetime')
plt.ylabel('MAE')
plt.grid()
plt.tight_layout()
plt.title('Model Prediction - Motor Belt')
plt.legend()
