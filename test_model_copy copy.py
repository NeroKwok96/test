...
#             fan_dataset_prediction(balancing_actual_data, misalignment_actual_data, belt_actual_data, flow_actual_data, bearing_actual_data, file_name)
#         elif sensor_id in allowed_motor_sensor_ids:
#             motor_dataset_prediction(balancing_actual_data, misalignment_actual_data, belt_actual_data, bearing_actual_data, file_name)



# def fan_dataset_prediction(balancing_actual_data, misalignment_actual_data, belt_actual_data, flow_actual_data, bearing_actual_data, file_name):
...
#     cursor_xswh = conn_to_xswh.cursor()
#     insert_xswh_query = """
#     INSERT INTO staging_machine_health (INSERT INTO staging_machine_health (node_id, sensor_location_name, machine_name, mae, health, organization_sym, site_sym, invoked_filename, health_type, computation_type) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
#     """
#     cursor_xswh.execute(insert_xswh_query, (int(sensor_id), sensor_location, machine_name, fan_misalignment_mae, fan_misalignment_machine_health, organization_sym, site_sym, file_name, 'balancing', 'model'))
...
# def motor_dataset_prediction(balancing_actual_data, misalignment_actual_data, belt_actual_data, bearing_actual_data, file_name):
...
#     # # XS warehouse query
#     cursor_xswh = conn_to_xswh.cursor()
#     insert_xswh_query = "INSERT INTO staging_machine_health (node_id, sensor_location_name, machine_name, mae, health, organization_sym, site_sym, invoked_filename, health_type, computation_type) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
def main():
    ...
    # Call functions, instantiate classes, perform operations, etc.
    pass
